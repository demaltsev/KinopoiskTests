...
public class KinoTest extends BaseTest {
    ...
    @DisplayName("Проверка количества элементов в при поиске")
    @Owner("Denis Maltsev")
    @Description("Выполняется поиск количества найденных элементов")
    @Test
    ...
    @Test
    @DisplayName("Проверка поиска фильма с заданными параметрами")
    @Owner("Denis Maltsev")
    ...
    @Test
    @DisplayName("Короткий тест на поиск фильма")
    @Owner("Denis Maltsev")
    @Description("Выполняется поиск фильма с заданными параметрами и проверяется что фильмы найдены")
